...
def order_to_timestamp(timestamp_dict: dict, ordering_dict: dict):
    ...
    #print("ENQ Sorted ordering dict: ", sorted_ordering_dict, "\n")
    latest_timestamp = 0
    for (key, v) in sorted_ordering_dict.items():
        ...
        if e_lin > d_end: raise Exception("Error: Incorrect timestamp or ordering dict")
    ...
    #print("DEQ Sorted ordering dict: ", sorted_ordering_dict, "\n")
